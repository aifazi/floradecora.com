        ...
        <div className="mx-auto max-w-content 2xl:max-w-content-2xl px-4 sm:px-6 md:px-10 lg:px-12 xl:px-10 2xl:px-8 py-16 md:py-24 grid lg:grid-cols-2 gap-10">
          <Reveal className="space-y-6 text-ink/70 dark:text-white/70 leading-relaxed text-lg">
            ...
            <div className="rounded-2xl overflow-hidden border border-black/5 dark:border-white/10">
              <Image src={cdnMedia("ChatGPT Image Jul 29, 2026, 11_42_38 PM.png")} alt="Desert oasis garden vision by Flora Decora" width={600} height={400} unoptimized className="w-full h-auto object-cover" quality={75} sizes="(max-width: 768px) 100vw, 600px" />
            </div>
          </Reveal>
