  ...
  return (
    <>
      <section className="relative min-h-[42vh] bg-forest-dim overflow-hidden flex items-end">
        <Image src="/images/hero-4.png" alt="" fill className="object-cover opacity-25" sizes="100vw" />
        ...
        <div className="relative mx-auto max-w-content w-full px-6 md:px-10 pt-32 pb-12 md:pt-44 md:pb-14">
          <Reveal><span className="inline-flex rounded-full bg-white/10 backdrop-blur border border-white/10 px-3 py-1 text-xs tracking-[0.14em] uppercase text-white/80">Contact</span></Reveal>
          ...
          <Reveal className="space-y-6">
            <div className="rounded-[1.6rem] bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 p-7 shadow-card dark:shadow-glow">
              <div className="space-y-8">
                <div>
                  <div className="eyebrow text-ink/40 mb-2">Office</div>
                  <p className="text-ink leading-relaxed">Office 106, Al Reef Building,<br />Asharij, Al Ain, UAE</p>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <div className="eyebrow text-ink/40 mb-2">Phone</div>
                    <a href="tel:+97137344243" className="font-medium hover:text-ochre-dark">+971 3 734 4243</a>
                  </div>
                  <div>
                    <div className="eyebrow text-ink/40 mb-2">Email</div>
                    <a href="mailto:info@floradecora.com" className="font-medium hover:text-ochre-dark">info@floradecora.com</a>
                  </div>
                </div>
                <div>
                  <div className="eyebrow text-ink/40 mb-2">Hours</div>
                  <p className="text-ink/70 text-sm">Sunday — Thursday, 8:00 AM — 5:00 PM<br />Site visits within 72h</p>
                </div>
              </div>
            ...
            <div className="rounded-[1.6rem] overflow-hidden h-[220px] relative bg-ink">
              <Image src="/images/hero-2.jpg" alt="Map" fill className="object-cover opacity-60" sizes="400px" />
              <div className="absolute inset-0 grid place-items-center">
                <span className="rounded-full bg-white px-4 py-2 text-xs font-medium shadow">📍 Al Ain, UAE</span>
              </div>
            </div>
          </Reveal>
