  ...
  return (
    <>
      ...
      <section className="bg-cream dark:bg-forest-dim">
        <div className="mx-auto max-w-content 2xl:max-w-content-2xl px-4 sm:px-6 md:px-10 lg:px-12 xl:px-10 2xl:px-8 py-12 md:py-16 grid lg:grid-cols-[1.2fr_0.8fr] gap-10">
          <Reveal>
      ...
      {related.length > 0 && (
        <section className="bg-white dark:bg-forest border-t border-black/5 dark:border-white/10">
          <div className="mx-auto max-w-content 2xl:max-w-content-2xl px-4 sm:px-6 md:px-10 lg:px-12 xl:px-10 2xl:px-8 py-12">
