...
export const PROJECTS: Project[] = [
  ...
  {
    slug: "vertical-garden-khalifa-city",
    title: "Vertical Garden — Khalifa City",
    type: "Photo",
    year: "2024",
    location: "Abu Dhabi, UAE",
    area: "800 m²",
    ...
    img: cdnMedia("8.png"),
    gallery: [cdnMedia("8.png"), cdnMedia("6.png")],
    description: "A two-storey vertical garden wrapping a villa courtyard — 12,000 plants across 40 species with integrated drip irrigation and automated nutrient dosing. Reduces ambient temperature by 6°C.",
    services: ["Themed Gardens", "Irrigation Systems"],
    built: true,
  },
  {
    slug: "sports-complex-al-ain",
    title: "Sports Complex — Al Ain",
    type: "Photo",
    year: "2024",
    location: "Al Ain, UAE",
    area: "25,000 m²",
    client: "Al Ain Sports Council",
    img: cdnMedia("6.png"),
    gallery: [cdnMedia("6.png"), cdnMedia("8.png"), cdnMedia("Picture2-min-scaled.jpg")],
    description: "Full landscaping for a multi-sport complex — football pitch, tennis courts, running track and spectator areas. Drought-tolerant turf variety selected for 45°C playability. Delivered in 10 weeks.",
    services: ["Outdoor Sports Facilities", "Irrigation Systems", "Maintenance"],
    built: true,
  },
  {
    slug: "ghaf-forest-initiative",
    title: "Ghaf Forest Initiative — Abu Dhabi",
    type: "Site Plan",
    year: "2025",
    location: "Abu Dhabi, UAE",
    area: "50,000 m²",
    ...
    img: cdnMedia("Picture4-min.png"),
    gallery: [cdnMedia("Picture4-min.png"), cdnMedia("Picture2-min-scaled.jpg")],
    description: "Master plan for a 5-hectare Ghaf forest reserve — 2,000 native trees, seed bank, research plots and public education trail. First phase planted in 2025, full completion 2027.",
    services: ["Landscaping Design", "Commercial Nurseries", "Development"],
    built: true,
  },
