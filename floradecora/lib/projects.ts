...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    area: "18,000 m²",
    client: "Al Ain Municipality",
    img: cdnMedia("hero-3.jpg"),
    gallery: [cdnMedia("hero-3.jpg"), cdnMedia("hero-2.jpg"), cdnMedia("Picture2-min-scaled.jpg")],
  ...
  },
  {
    ...
    img: cdnMedia("hero-2.jpg"),
    gallery: [cdnMedia("hero-2.jpg"), cdnMedia("Picture4-min.png"), cdnMedia("hero-4.png")],
